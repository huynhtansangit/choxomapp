                ...
                <td style="border:#dddddd solid 1px;border-top:0px;direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top">
                    ...
                    <div class="m_-2985700777964797137mj-column-per-100"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="text-align:center">
                                                <img src="<?php echo HTTP_SERVER;?>assets/images/logo-customer.png"
                                                     style="width:50%" width="64" class="CToWUd">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td align="center"
                                    style="font-size:16px;padding:10px 25px;padding-bottom:40px;word-break:break-word">
                            ...
                            <tr>
                                <td align="center"
                                    style="font-size:16px;padding:10px 25px;padding-bottom:0;word-break:break-word">
                            ...
                            <tr>
                                <td align="center" style="font-size:16px;padding:10px 25px;word-break:break-word">
                                    <div
                                            style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555">
                                        Cảm ơn bạn đã quan tâm sản phẩm của GBShop. Đơn hàng <strong><?php echo $data['ordercode'];?></strong> của bạn đã được chúng tôi
                            ...
                            <tr>
                                <td align="center"
                                    style="font-size:16px;padding:10px 25px;padding-bottom:20px;word-break:break-word">
                                    <div
                                            style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555">
                            ...
                            <tr>
                                <td align="center" style="padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#555;">
                                        Please send and feedback or bug info<br> to <a href="<?php echo HTTP_ROOTSERVER?>" style="color:#2F67F6"><?php echo HTTP_ROOTSERVER?></a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
