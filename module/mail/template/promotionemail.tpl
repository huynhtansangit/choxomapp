...
<div style="background-color:#f9f9f9">
    <div style="background:#f9f9f9;background-color:#f9f9f9;Margin:0px auto;max-width:600px">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tbody>
            <tr>
                <td style="border-bottom:#0182f9 solid 5px;direction:ltr;padding:20px 0;text-align:center;vertical-align:top">
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <div style="background:#fff;background-color:#fff;Margin:0px auto;max-width:600px">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tbody>
            <tr>
                <td style="border:#dddddd solid 1px;border-top:0px;direction:ltr;padding:20px 0;text-align:center;vertical-align:top">
                    ...
                    <div class="m_-2985700777964797137mj-column-per-100"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="text-align:center">
                                                <img src="<?=HTTP_SERVER?>data/fileserver/images/fixsize-600x140/<?=$data['webconfig']['logodark']?>"
                            ...
                            <tr>
                                <td align="center"
                                    style="padding:10px 25px;padding-bottom:20px;word-break:break-word">
                                    <div
                            ...
                            <tr>
                                <td align="center" style="padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#555;">
                                        Vui lòng gửi phản hồi của bạn<br>đến <a href="mailto:<?=$data['webconfig']['email']?>" style="color:#2F67F6"><?=$data['webconfig']['email']?></a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
