                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo IMAGE_SERVER ?>fixsize-600x120/<?php echo $data['webconfig']['logodark']?>"
                                                     width="300" height="60">
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                        Mật khẩu mới của bạn: <?php echo $data['newpassword']?>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                        <tr>
                                            <td align="center" role="presentation" valign="middle">
                                                <a href="<?php echo HTTP_SERVER?>gbuser/login.gbe"
                                                   style="border-radius: 3px; padding:15px 25px;background:#0182f9;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                    Đăng nhập
                                                </a>
                                            </td>
                                        </tr>
