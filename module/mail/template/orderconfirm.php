                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="text-align:center">
                                                <img src="<?php echo IMAGE_SERVER ?>fixsize-600x120/<?php echo $webconfig['logodark']?>"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        ...
                                        Dear <?php echo $data['customername'] ?>,
                                    </div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word">
                                    <div
                                        style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555">
                                        Cảm ơn bạn đã quan tâm sản phẩm của GBShop. Đơn hàng <strong><?=$data['ordercode']?></strong> của bạn đã được chúng tôi
                                        tiếp nhận.
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555">
                                        Để xem chi tiết đơn hàng của mình tại gbshop.com, bạn có thể <a href="#">nhấn
                                            vào đây</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;padding:10px 15px">
                                        <h4 style="color:#8083c5">THÔNG TIN ĐƠN HÀNG #<?=$data['ordercode']?> (Ngày đặt <?=$data['ordercreateddate']?>)</h4>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:28px;padding:0px 30px">
                                        <div style="width:100%">
                                        ...
                                        <table style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <b>Khách hàng: </b><?=$data['cardname']?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <b>Email: </b><a href="mailto:<?=$data['cardemail']?>"
                                                                     target="_blank"><?=$data['cardemail']?></a></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <b>Số điện thoại: </b> <?=$data['cardphone']?>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                            ...
                            <tr>
                                <td>
                                    <div style="padding:10px 15px">
                                        <h4 style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;color:#8083c5">CHI TIẾT ĐƠN HÀNG</h4>
                                        <table style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;width:100%;border-collapse:collapse">
                                            ...
                                            <?php foreach ($data[productlist] as $product) { ?>
                                                <tr style="background-color:#eaeaea;border-bottom:1px solid #d4d4d4">
                                                    ...
                                                    <td style="padding:8px;text-align:right;width:11%;white-space:nowrap">
                                                        ...
                                                        <?php if ($product['baseprice'] != number_format($product['sellingprice'],0,',','.') ||
                                                            ($product['baseprice'] != number_format(($product['sellingprice'] - ($product['promotionamount']/$product['quantity'])),0,',','.'))) { ?>
                                                            <p class="my-0 py-0"><span
                                                                    style="text-decoration: line-through;font-size:85%"><?php echo number_format($product['baseprice'],0,',','.'); ?></span>
                                                            </p>
                                                        <?php } ?>

                                                        <p class="my-0 py-0" style="font-weight:bold"><?php echo number_format(($product['sellingprice'] - ($product['promotionamount']/$product['quantity'])),0,',','.'); ?></p>
                                            ...
                                            <tr style="background-color:#eaeaea;border-bottom:1px solid #d4d4d4">
                                                ...
                                                <td style="padding:8px;text-align:right;width:11%;white-space:nowrap">
                                                    <?=number_format($data['totallines'],0,',','.')?>
                                                </td>
                                            ...
                                            <tr style="background-color:#eaeaea;border-bottom:1px solid #d4d4d4">
                                                ...
                                                <td style="padding:8px;text-align:right;width:11%;white-space:nowrap">
                                                    <?=number_format($data['promotionamount'],0,',','.')?>
                                                </td>
                                            </tr>
                                            <tr style="background-color:#eaeaea;border-bottom:1px solid #d4d4d4">
                                                <td></td><td></td>
                                                ...
                                                <td style="padding:8px;text-align:right;width:11%;white-space:nowrap">
                                                    <?php
                                                        if (empty($data['ordershipprice'])){
                                                            ...
                                                            echo number_format($data['ordershipprice'],0,',','.');
                                                        }
                                                    ?>
                                                </td>
                                            </tr>
                                            <tr style="background-color:#eaeaea;border-bottom:1px solid #d4d4d4">
                                                ...
                                                <td style="padding:8px;text-align:right;width:11%;white-space:nowrap">
                                                    <?=number_format($data['ordertotal'],0,',','.')?>
                                                </td>
                                            </tr>
