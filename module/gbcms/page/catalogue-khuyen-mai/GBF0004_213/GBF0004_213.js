...
document.addEventListener("DOMContentLoaded", function() {
    var catalogueSwiper = new Swiper('.catalogue__swiper', {
        //loop: true,
        spaceBetween: 30,
        slidesPerView: 1,
        slidesPerGroup: 1,
        ...
        pagination: {
            el: '.catalogue__pagination',
            clickable: true
        },

        // Navigation arrows
        navigation: {
            nextEl: '.catalogue__btn__next',
            prevEl: '.catalogue__btn__prev'
        }
    });

    // execute photoswipe function
    initPhotoSwipeFromDOM('.catalogue__photoswipe');
});