...
<div class="orderdetail__progress__block--absolute">
        ...
        <div class="orderdetail__info">
            <div class="row">
                ...
                <div class="orderdetail__info__column col-lg-5">
                    <?php if ($orderDetailData["data"]["iscollect"] == 1 ) { ?>
                    <p class="orderdetail__info__column__title">Lấy hàng tại cửa hàng:</p>
                    <div class="orderdetail__info__block">
                        <p><?php echo $webconfig['businessname'] ?></p>
                        <p>Địa chỉ: <a href="<?php echo $webconfig['googlemaplink'] ?>" target="_blank"><?php echo $webconfig['address'] ?></a></p>
                        <p>Số điện thoại: <a href="tel:<?php echo $webconfig['zaloviber'] ?>"><?php echo $webconfig['zaloviber'] ?></a></p>
                    </div>
                    <?php } else { ?>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <p class="mb-0" style="font-weight:bold"><?php echo number_format($product['sellingprice'], 0, ',', '.') . $webconfig['currency']; ?></p>
